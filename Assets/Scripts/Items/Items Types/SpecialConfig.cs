...
namespace RPG.Items
{
    ...
    public class SpecialConfig : ItemConfig
    {
        ...
        public void LaunchProjectile(Transform rightHand, Transform leftHand, IDamagable target, GameObject instigator, float calculatedDamage)
        {
